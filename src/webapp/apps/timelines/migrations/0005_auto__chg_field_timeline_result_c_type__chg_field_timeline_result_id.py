...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timeline.result_c_type'
        db.alter_column('timelines_timeline', 'result_c_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contenttypes.ContentType']))

        # Changing field 'Timeline.result_id'
        db.alter_column('timelines_timeline', 'result_id', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Timeline.result_c_type'
        raise RuntimeError("Cannot reverse this migration. 'Timeline.result_c_type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Timeline.result_id'
        raise RuntimeError("Cannot reverse this migration. 'Timeline.result_id' and its values cannot be restored.")
    ...
    models = {
        ...
        'timelines.timeline': {
            ...
            'result_c_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'result_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
