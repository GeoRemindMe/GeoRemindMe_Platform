...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimelineNotification.actor_id'
        db.alter_column('timelines_timelinenotification', 'actor_id', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'TimelineNotification.actor_id'
        db.alter_column('timelines_timelinenotification', 'actor_id', self.gf('django.db.models.fields.PositiveIntegerField')())
