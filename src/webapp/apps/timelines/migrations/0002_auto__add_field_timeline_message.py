...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Timeline.message'
        db.add_column('timelines_timeline', 'message', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Timeline.message'
        db.delete_column('timelines_timeline', 'message')
