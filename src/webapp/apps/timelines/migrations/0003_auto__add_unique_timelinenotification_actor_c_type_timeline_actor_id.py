...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TimelineNotification', fields ['actor_c_type', 'timeline', 'actor_id']
        db.create_unique('timelines_timelinenotification', ['actor_c_type_id', 'timeline_id', 'actor_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TimelineNotification', fields ['actor_c_type', 'timeline', 'actor_id']
        db.delete_unique('timelines_timelinenotification', ['actor_c_type_id', 'timeline_id', 'actor_id'])
    ...
    models = {
        ...
        'timelines.timelinenotification': {
            'Meta': {'unique_together': "(('timeline', 'actor_c_type', 'actor_id'),)", 'object_name': 'TimelineNotification'},
