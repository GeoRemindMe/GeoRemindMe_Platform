...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Suggestion.location'
        db.add_column('events_suggestion', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Suggestion.location'
        db.delete_column('events_suggestion', 'location')
