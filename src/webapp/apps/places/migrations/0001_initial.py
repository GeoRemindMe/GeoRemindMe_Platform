...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('places_place', (
            ...
            ('created', self.gf('modules.timezones.fields.LocalizedDateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('modules.timezones.fields.LocalizedDateTimeField')(auto_now=True, blank=True)),
        ))
