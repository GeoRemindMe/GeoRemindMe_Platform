...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('places_place', 'google_places_reference', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))

        # Changing field 'Place.address'
        db.alter_column('places_place', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=512))


    def backwards(self, orm):
        
        # Changing field 'Place.google_places_reference'
        db.alter_column('places_place', 'google_places_reference', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Place.address'
        db.alter_column('places_place', 'address', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
    ...
    models = {
        ...
        'places.place': {
            ...
            'google_places_reference': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '1024', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
