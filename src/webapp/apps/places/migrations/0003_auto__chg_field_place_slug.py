...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('places_place', 'slug', self.gf('webapp.site.fields.AutoSlugField')(populate_from=['name', 'city'], allow_duplicates=False, max_length=150, separator=u'-', unique=True, overwrite=False))


    def backwards(self, orm):
        
        # Changing field 'Place.slug'
        db.alter_column('places_place', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=150, unique=True))
    ...
    models = {
        ...
        'places.place': {
            ...
            'slug': ('webapp.site.fields.AutoSlugField', [], {'populate_from': "['name', 'city']", 'allow_duplicates': 'False', 'max_length': '150', 'separator': "u'-'", 'blank': 'True', 'unique': 'True', 'overwrite': 'False', 'db_index': 'True'}),
