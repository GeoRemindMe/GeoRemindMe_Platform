...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Place.adress'
        db.alter_column('places_place', 'adress', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))


    def backwards(self, orm):
        
        # Changing field 'Place.adress'
        db.alter_column('places_place', 'adress', self.gf('django.db.models.fields.CharField')(default='', max_length=512))
    ...
    models = {
        ...
        'places.place': {
            ...
            'adress': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
