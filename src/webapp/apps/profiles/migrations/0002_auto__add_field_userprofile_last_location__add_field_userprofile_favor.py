...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_userprofile', 'last_location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.favorite_location'
        db.add_column('profiles_userprofile', 'favorite_location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.last_location'
        db.delete_column('profiles_userprofile', 'last_location')

        # Deleting field 'UserProfile.favorite_location'
        db.delete_column('profiles_userprofile', 'favorite_location')
